	...
	$(document).ready(function() {
		...
		if(cart == null){
			...
			for (var i = 0; i < cart.length; i++) {
				...
				$('tbody').append('<tr> <td class="pro-remove"><a href="#" class="xoa" value="'+cart[i].masanpham+'">Xóa</a> </td> <td class="pro-thumbnail" style="width: 150px;"><a href="#"><img src="admin/assets/images/'+cart[i].anhchinh+'" alt="Product"></a></td> <td class="pro-title"><a href="detail.php/book_id='+cart[i].masanpham+'">'+cart[i].tensanpham+'</a></td> <td class="pro-price"><span>'+gia.toLocaleString('vi', {style : 'currency', currency : 'VND'})+'</span></td> <td class="pro-quantity"> <div class="pro-qty"> <div class="count-input-block"> <input type="number" class="form-control text-center number" data="'+cart[i].masanpham+'" value="'+cart[i].soluong+'"> </div> </div> </td> <td class="pro-subtotal"><span>'+gia.toLocaleString('vi', {style : 'currency', currency : 'VND'})+'</span></td> </tr>')
				tien += gia
			}
